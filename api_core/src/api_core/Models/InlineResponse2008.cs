...
{ 
    ...
    { 
        ...
        /// <summary>
        /// Amount without fee. Is integer as string, aligned to the asset accuracy. Should be non empty if the  state is  Completed.
        /// </summary>
        /// <value>Amount without fee. Is integer as string, aligned to the asset accuracy. Should be non empty if the  state is  Completed.</value>
        ...
        /// </summary>
        /// <value>Fee should be zero if the  state is  Completed.</value>
        [DataMember(Name="fee")]
